...
* The original package name 'com.springboot.jpa.hibernate.database-hibernate' is invalid and this project uses 'com.springboot.jpa.hibernate.databasehibernate' instead.
